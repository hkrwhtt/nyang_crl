...
#웹페이지 열기 (수정)
driver.get("https://ratio.uwayapply.com/Sl5KOldCL0pmJSY6JkotZlRm")
time.sleep(10)
...
for row in rows:
    ...
    if len(values) >= 3:  
        major_name = values[1]  
        if "의예과" not in major_name and "약학과" not in major_name and "수의예과" not in major_name:
            continue
...
filename = "/home/ubuntu/scr_prc/전북대학교_2026_수시_경쟁률_추이.xlsx" # 수정
# filename = r"C:\파이썬 아이들\scr_prc\전북대학교_2026_수시_경쟁률_추이.xlsx"
