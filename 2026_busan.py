...
#웹페이지 열기 (수정)
driver.get("https://addon.jinhakapply.com/RatioV1/RatioH/Ratio12100541.html")
time.sleep(10)
...
filename = "/home/ubuntu/scr_prc/부산대학교_2026_수시_경쟁률_추이.xlsx" # 수정
# filename = r"C:\파이썬 아이들\scr_prc\부산대학교_2025_수시_경쟁률_추이.xlsx"
